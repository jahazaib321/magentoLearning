...
use Mage4\StoreLocator\Api\Data\DataInterfaceFactory;
use Mage4\StoreLocator\Api\Data\DataSearchResultsInterfaceFactory;
use Mage4\StoreLocator\Model\ResourceModel\Item as ResourceData;
use Mage4\StoreLocator\Model\ResourceModel\Item\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($Id)
    {
        if (!isset($this->instances[$Id])) {
            /** @var \Mage4\StoreLocator\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \Mage4\StoreLocator\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \Mage4\StoreLocator\Model\ResourceModel\Item\Collection $collection */
        /** @var \Mage4\StoreLocator\Model\ResourceModel\Item\Collection $collection */
