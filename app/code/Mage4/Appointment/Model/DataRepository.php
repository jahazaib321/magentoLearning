...
use Mage4\Appointment\Api\Data\DataSearchResultsInterfaceFactory;
use Mage4\Appointment\Model\ResourceModel\Data as ResourceData;
use Mage4\Appointment\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($Id)
    {
        if (!isset($this->instances[$Id])) {
            /** @var \Mage4\Appointment\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
    ...
    {
        /** @var \Mage4\Appointment\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \Mage4\Appointment\Model\ResourceModel\Data\Collection $collection */
